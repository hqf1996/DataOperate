...
public class FieldFindExpertProcessJobcontrol {
	...
	private static Map<String, String[]> pathInit(Configuration conf,String[] inputPath){
		...
		pathMap.put("preCutPaper", new String[]{fs + "/user/offlineCalculationData/yuan/cut/paper", fs + "/user/offlineCalculationData/yuan/cut_add_merge_words" + currentDate +"/paper"});
		pathMap.put("preCutPatent", new String[]{fs + "/user/offlineCalculationData/yuan/cut/patent", fs + "/user/offlineCalculationData/yuan/cut_add_merge_words"+ currentDate +"/patent"});
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
		...
		jobsList.add(JobFactor.createJob("final join", conf4, FieldFindExpertProcessJobcontrol.class, FinalJoin.FinalJoinMap.class,
