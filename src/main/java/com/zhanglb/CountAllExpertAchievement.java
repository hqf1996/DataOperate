 ...
 * @author yhj
 */
public class CountAllExpertAchievement {
	public static class CountAllExpertAchievementMap extends Mapper<Object, Text, Text, Text>{
	...
	public static class CountAllExpertAchievementReduce extends Reducer<Text, Text, Text, NullWritable>{
		public Text outKey = new Text();
		...
		protected void reduce(Text key, Iterable<Text> values, Reducer<Text, Text, Text, NullWritable>.Context context)
			...
			for(Text value:values){
				...
				if(baidu.equals("99") && !infos[15].equals("99") && !infos[15].equals("null")){
					baidu = infos[15];
				}else if (baidu.equals("02") && infos[15].equals("01")) {
					baidu = infos[15];
				}
			}
